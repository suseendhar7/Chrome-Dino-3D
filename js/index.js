...
document.getElementById("message").style.left = "650px"
var crash = false;
var score = 0;
...
function makeRandomCube() {
    ...
    //box.position.z = getRandomArbitrary(-500, -1200);
    box.position.z = getRandomArbitrary(-camera.position.z-400, -(camera.position.z+1500));
    cubes.push(box);
    box.name = "box_" + id;
    id++;
